        ...
        <div class="container pb-11 pt-12">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                    <form class="" method="post" action="{{ route('admission.acceptance.invoice') }}"  enctype="multipart/form-data">
                        @csrf
                        <div class="row gx-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-4">
                                    <input id="form_session" type="text" name="session" class="form-control" required value="2020/2021" readonly >
                            ...
                            <div class="col-12 text-center">
                                <input type="submit" class="btn btn-primary rounded-pill btn-send mb-3" value="Get Invoice">
                            </div>
                            <!-- /column -->
                        </div>
                        <!-- /.row -->
