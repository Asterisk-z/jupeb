        ...
        <div class="container pt-10 pb-12 pt-md-10 pb-md-10 text-center">
            <div class="row">
                <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
                    <h1 class="display-1 mb-3">School Fee Invoice</h1>
                    <p class="lead px-xxl-10">Print and take the invoice to any bank branch to pay School fee</p>
                </div>
            <!-- /column -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card-body p-3">
                                <div class="row pl-5 pr-5">
                                    ...
                                    <div class="col-md-9">
                                        @if ($payment->schoolFee_status == 'PAID')
                                ...
                                <div class="row pl-5 pr-5 pt-3">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>{{ $payment->schoolFee_invoice  }}</td>
                                                    <td>{{ __('JUPEB SCHOOL FEE') }}</td>
                                                    <td>{{ 'NGN'. number_format($payment->schoolFee_amount)  }}</td>
