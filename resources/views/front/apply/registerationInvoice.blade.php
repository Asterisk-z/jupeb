                    ...
                    <div class="card p-3 border-5">
                        <div class="card p-3" id="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img src="{{ asset('images/logo/unical.png') }}" width="100" height="100" alt=""
                                            sizes="20" srcset="">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="text-center">
                                            <h1 class="text-uppercase text-primary ">university of calabar</h1>
                                            <h6 class="text-uppercase text-danger">p.m.b 1115, calabar, cross river state,
                                                nigeria</h6>
                                            <h6 class="text-uppercase text-default">joint university preliminary
                                                examinations board</h6>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <img src="{{ asset('images/logo/jupeb.png') }}" width="100" height="100" alt=""
                                            sizes="20" srcset="">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-3">
                                <div class="row pl-5 pr-5">
                                    ...
                                    <div class="col-md-9">
                                        @if ($payment->registration_status == 'PAID')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <h4 class="text-uppercase text-center">{{ $student->lastName }}
                                            {{ $student->firstName }} {{ $student->middleName }}</h4>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>{{ $payment->registration_invoice }}</td>
                                                        <td>{{ __('JUPEB REGISTRATION FEE') }}</td>
                                                        <td>{{ 'NGN' . number_format($payment->registration_amount) }}
                                                        </td>
                        ...
                        <a href="#" onclick="window.print('#card');"
                            class="btn btn-success float-right d-print-none">Print</a>
                    </div>
                </div>
